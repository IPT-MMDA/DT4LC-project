...
@router.post("/v1/gee/sentinel2")  # type: ignore[misc]
...
@router.post("/v1/gee/modis")  # type: ignore[misc]
...
@router.post("/v1/gee/landsat")  # type: ignore[misc]
...
@router.post("/v1/gee/bulk-fetch")  # type: ignore[misc]
...
@router.get("/v1/gee/datasets")  # type: ignore[misc]
...
@router.post("/v1/gee/layers/persist")  # type: ignore[misc]
...
@router.post("/v1/gee/layers/{layer_id}/export")  # type: ignore[misc]
...
@router.get("/v1/gee/layers")  # type: ignore[misc]
...
@router.delete("/v1/gee/layers/{layer_id}")
...
@router.get("/v1/gee/dates")  # type: ignore[misc]
